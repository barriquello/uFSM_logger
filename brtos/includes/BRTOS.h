...
#else
INT8U InstallTask(void (*FctPtr)(void), const CHAR8 *TaskName,
		INT16U USER_STACKED_BYTES, INT8U iPriority, OS_CPU_TYPE *TaskHandle);
#endif
 ...
 *********************************************************************************************/
INT8U DelayTaskHMSM(INT8U hours, INT8U minutes, INT8U seconds,
		INT16U miliseconds);
